...
export const createTopic = async (chapterSlug: string, values: z.infer<typeof tutorialTopicSchema>) => {
    try {
...
export const updateTopic = async (topicSlug: string, values: z.infer<typeof tutorialTopicSchema>) => {
    try {
        if (!topicSlug) {
            return {
                success: false,
