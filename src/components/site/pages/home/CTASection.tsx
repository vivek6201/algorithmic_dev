  ...
  return (
    <div className="bg-gradient-to-r from-purple-300 to-purple-500 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-10">
        <div
          className="absolute top-10 left-10 w-20 h-20 rounded-full bg-white animate-pulse"
          style={{ animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-10 right-10 w-32 h-32 rounded-full bg-white animate-pulse"
          style={{ animationDuration: "5s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-16 h-16 rounded-full bg-white animate-pulse"
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10 animate-fade-in">
        ...
        <p className="mt-4 text-xl text-white/90 max-w-2xl mx-auto">
          Join thousands of tech professionals whove found jobs, made
          connections, gained knowledge, and advanced their careers.
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <div
            className="rounded-md shadow animate-fade-in"
          ...
          <div className="" style={{ animationDelay: "400ms" }}>
            <Button
              variant="outline"
              className="px-8 py-3 border-white hover:bg-white/10 transition-transform hover:scale-105"
            >
              Learn more
            </Button>
          </div>
